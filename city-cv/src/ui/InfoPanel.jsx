    ...
    <>
      ...
      <div className="p-section">
        ...
        <div className="tag-cloud">
          {['HTML5','CSS3','JavaScript','React','Firebase','FastAPI','ESP32','Google Sheets API','Tinkercad','Canva','Git','C/C++','Java'].map(tag => (
...
function ContactPanel() {
  return (
    <>
      ...
      <div className="p-section">
        <p className="p-text" style={{ marginBottom: 8 }}>
          B.Tech CSE · 2nd Year · Graduating 2028
        </p>
        <p className="p-text" style={{ marginBottom:14, color:'var(--c-gold)' }}>
          🎯 GATE CSE Aspirant · Open to internships & collaborations
        </p>
        {[
          { icon:'✉️', lbl:'Email',      val: OWNER.email },
          { icon:'💼', lbl:'LinkedIn',   val: OWNER.linkedin },
          { icon:'🐙', lbl:'GitHub',     val: OWNER.github },
          { icon:'🏆', lbl:'Hackathon',  val: 'Tic Tac Hackathon — ReWear Project' },
          { icon:'📚', lbl:'Currently',  val: 'Preparing for GATE CSE' },
        ].map(c => (
